...
from data_process.feature_structure import create_samples
...
X_seq, X_weekly, y = create_samples(day_data)
...
for epoch in range(20):
    ...
    log_epoch_predictions(all_preds, all_labels, epoch, save_path="logs/epoch_prediction_log.csv")
    ...
    log_epoch_predictions(val_preds, val_labels, epoch, save_path="logs/val_epoch_prediction_log.csv")
...
log_epoch_predictions(test_preds, test_labels, 0, save_path="logs/test_prediction_log.csv")

log_path = "logs/epoch_prediction_log.csv"
...
log_path = "logs/val_epoch_prediction_log.csv"
#result = count_predictions(log_path)
...
log_path = "logs/test_prediction_log.csv"
#result = count_predictions(log_path)
